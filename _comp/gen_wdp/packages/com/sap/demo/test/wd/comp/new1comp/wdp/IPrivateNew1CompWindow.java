...
// $JL-GENERATED-SOURCE$
// ---------------------------------------------------------------------------
package com.sap.demo.test.wd.comp.new1comp.wdp;
...
public interface IPrivateNew1CompWindow extends com.sap.demo.test.wd.comp.new1comp.wdp.IPublicNew1CompWindow {
  ...
  public static IWDEventHandlerId WD_EVENTHANDLER_ON_PLUG_DEFAULT = new com.sap.tc.webdynpro.progmodel.gci.impl.GCIEventHandlerId("onPlugDefault", "New1CompWindow", "com.sap.demo.test.wd.comp.new1comp.New1Comp");
  ...
  {
    private static final long serialVersionUID = 0xc8a6d11c388b6513L;
