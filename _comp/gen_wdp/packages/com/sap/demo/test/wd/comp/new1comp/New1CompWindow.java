...
// ---------------------------------------------------------------------------
package com.sap.demo.test.wd.comp.new1comp;
...
//
//@@begin imports
import com.sap.demo.test.wd.comp.new1comp.wdp.IPrivateNew1CompWindow;
...
{
  private static final long serialVersionUID = 0x90279cb66d39e409L;
   ...
   * component usages.
   *
   * @see com.sap.demo.test.wd.comp.new1comp.wdp.IPrivateNew1CompWindow for more details
   */
  @SuppressWarnings("unused")
   ...
   *
   * @see com.sap.demo.test.wd.comp.new1comp.wdp.IPrivateNew1CompWindow.IContextNode for more details.
   */
  @SuppressWarnings("unused")
