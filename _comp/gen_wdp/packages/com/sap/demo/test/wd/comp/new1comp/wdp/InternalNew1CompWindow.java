...
{
  private static final long serialVersionUID = 0xa20a0ade7b505045L;
   ...
   */
  private final com.sap.demo.test.wd.comp.new1comp.New1CompWindow delegate;
  ...
  public InternalNew1CompWindow(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    ...
    wdInitContextNode();
    this.delegate = new com.sap.demo.test.wd.comp.new1comp.New1CompWindow((IPrivateNew1CompWindow) this);
  }
