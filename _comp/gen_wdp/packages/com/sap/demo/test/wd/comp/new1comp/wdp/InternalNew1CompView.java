...
{
  private static final long serialVersionUID = 0xab304d13c8b20cd5L;
   ...
   */
  private final com.sap.demo.test.wd.comp.new1comp.New1CompView delegate;
  ...
  public InternalNew1CompView(com.sap.tc.webdynpro.progmodel.gci.IGCIView alterEgo) {
    ...
    wdInitContextNode();
    this.delegate = new com.sap.demo.test.wd.comp.new1comp.New1CompView((IPrivateNew1CompView) this);
  }
